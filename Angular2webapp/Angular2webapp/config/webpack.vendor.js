...
module.exports = {
    ...
    plugins: [
        vendorLESS,
        new webpack.ProvidePlugin({ $: "jquery", jQuery: "jquery", sly: "sly" }), // Maps these identifiers to the jQuery package (because Bootstrap expects it to be a global variable)
